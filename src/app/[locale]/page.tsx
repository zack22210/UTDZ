...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: { title: messages.home.meta.title, description: messages.home.meta.description, url: siteUrl, siteName: "Universal Tower Defense Z Wiki", images: [{ url: image }] },
...
export default async function LocaleHomePage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const webSite = { "@context": "https://schema.org", "@type": "WebSite", name: "Universal Tower Defense Z Wiki", url: siteUrl, description: messages.home.meta.description };
